...
iterBuilder :: MonadIO m => ([ByteString] -> IO ()) -> E.Iteratee Builder m ()
...
iterBuilderWith :: MonadIO m => Int -> ([ByteString] -> IO ()) -> E.Iteratee Builder m ()
iterBuilderWith !bufSize' io = E.continue (createBufferI bufSize')
  where
